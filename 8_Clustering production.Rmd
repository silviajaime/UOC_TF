...
#Nota: estos resultados corresponden al apartado 2.6.6. K-means precio medio, demanda y tipo de producci??n
...
- Cluster 3: Precio bajo, produccion eolica muy alta, produccion solar baja, demanda baja
- Cluster 4: precio interemedio, produccion eolica muy alta, produccion solar media, demanda muy alta
- Cluster 5: precio intermedio, produccion eolica baja, produccion solar baja, demanda baja

Observamos que los clusters 4 y 2 tienen demanda alta pero en el cluster 4 el precio es mas bajo. Si analizamos los tipos de produccion vemos que en este caso la produccion eolica es mucho mas alta. Por otra parte, los custers 3 y 5 tienen una distribucion de demanda similar. No obstante, en el cluster 3 el precio es mucho mas bajo. Si observamos el tipo de distribucion podemos ver que la produccion de energia eolica es mucho superior en el cluster 3. 
...
Observamos de nuevo que el grupo 1 y 2 tienen demanda similar pero el precio del grupo 1 es mucho mas bajo. La distribucion de produccion del grupo 1 incluye csai el doble de produccion eolica que el grupo 2. La demanada mas baja se encuentra en el grupo 4, no obstante el precio es medio. Si observamos la distribucion de la produccion, ese grupo tiene muy poca produccion solar y poca produccion eolica.
